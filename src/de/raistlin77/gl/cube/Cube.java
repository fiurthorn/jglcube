...
public class Cube {
	...
	private void E3() {
		...
		if ( T22.TRi( new Tile.Color[] { Tile.Color.GREEN, Tile.Color.YELLOW } ) && T16.TRi( new Tile.Color[] { Tile.Color.RED, Tile.Color.YELLOW } ) ) {
			move( (byte) 7 );
			move( (byte) 7 );
			K3E();
			move( (byte) 10 );
	...
	public String toString(){
		...
		sb.append( String.format( "               +---+---+---+\n" ) );
		sb.append( String.format( " +---+---+---+ +---+---+---+ +---+---+---+ +---+---+---+\n" ) );
		sb.append( String.format( " + %s + %s + %s + + %s + %s + %s + + %s + %s + %s + + %s + %s + %s +\n", L1, L2, L3, V1, V2, V3, R1, R2, R3, H1, H2, H3 ) );
		sb.append( String.format( " +---+---+---+ +---+---+---+ +---+---+---+ +---+---+---+\n" ) );
		sb.append( String.format( " + %s + %s + %s + + %s + %s + %s + + %s + %s + %s + + %s + %s + %s +\n", L4, L5, L6, V4, V5, V6, R4, R5, R6, H4, H5, H6 ) );
		sb.append( String.format( " +---+---+---+ +---+---+---+ +---+---+---+ +---+---+---+\n" ) );
		sb.append( String.format( " + %s + %s + %s + + %s + %s + %s + + %s + %s + %s + + %s + %s + %s +\n", L7, L8, L9, V7, V8, V9, R7, R8, R9, H7, H8, H9 ) );
		sb.append( String.format( " +---+---+---+ +---+---+---+ +---+---+---+ +---+---+---+\n" ) );
		sb.append( String.format( "               +---+---+---+\n" ) );
		sb.append( String.format( "               + %s + %s + %s +\n", U1, U2, U3 ) );
		sb.append( String.format( "               +---+---+---+\n" ) );
